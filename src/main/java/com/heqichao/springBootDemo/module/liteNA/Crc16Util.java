...
public class Crc16Util {
     ...
     * @return 结果字符串
     */
    public static String getRestultByString(String str) {
    	String[] strings = StringUtil.string2StringArray(str);
    	byte[] data = new byte[]{};
    	for (int i = 0; i<strings.length;i++) {
    		int x = Integer.parseInt(strings[i], 16);
    		byte n = (byte)x;
    	...
    	byte[] dataArr = getData(data);
    	String resString = byteTo16String(dataArr);
